    ...
    if (popup) {
        return (
            <div className="w-[90%] flex flex-col justify-center items-center gap-8 p-8 m-[auto]">
                ...
                <div className="flex flex-col justify-center items-center w-[70%] mx-auto gap-2 bg-lavender_blush-900 p-6 rounded-md shadow-md shadow-ebony-900">
                ...
                <div className="bg-lavender_blush-900 rounded-md w-[50%] m-6 p-8 shadow-md shadow-ebony-900">
