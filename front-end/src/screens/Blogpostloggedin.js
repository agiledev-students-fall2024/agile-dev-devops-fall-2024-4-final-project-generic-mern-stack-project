...
//         if (postResponse.data.author_id) {
//           const authorResponse = await axios.get(`${process.env.REACT_APP_API_URL}/api/users/${postResponse.data.author_id}`);
//           setAuthor(authorResponse.data);
//         }

//         const loggedInResponse = await axios.get(`${process.env.REACT_APP_API_URL}/api/users/loggedIn`);
