...
const NavigationBar = (props) => {
  ...
  return (
    <nav
      className={`dark:bg-lavender_blush-1001 absolute h-[100vh] lg:relative bg-lavender_blush-900 h-screen p-8 text-xl shadow-md shadow-ebony-900 ${isSmall ? "w-[80%] md:w-[45%] z-20" : "w-1/4"
        }`}
    >
